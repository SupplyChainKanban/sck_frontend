...
export default function DashboardLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    ...
    //     </div>
    //   </nav>
    //   <div className="flex overflow-hidden bg-black pt-16">
    //     <aside
    //       id="sidebar"
    //       className="fixed hidden z-20 h-full top-0 left-0 pt-16 lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75"
    //       aria-label="Sidebar"
    //     >
    //       <div className="relative flex-1 flex flex-col min-h-0 borderR border-gray-200 bg-black pt-0">
    ...
    //             <div className="bg-black shadow rounded-lg p-4 sm:p-6 xl:p-8">
    //               {children}
    //             </div>
    //           </div>
    //         </div>
    //       </main>
    //       <footer className="bg-black md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
